...
public class CategoryFragmentubcv3chapter6 extends Fragment {
    ...
    public static CategoryFragmentubcv3chapter6 newInstance(){
        CategoryFragmentubcv3chapter6 categoryFragment = new CategoryFragmentubcv3chapter6();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv3chapter6";
