...
public class HewbrewBible extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hewbrew_bible);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), UbcvThreeChapterTwo.class);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("1fNWTZZwgbs");
        }
    }
