...
public class GodMadeMe extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_god_made_me);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), UbcvTwoChapterOne.class);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("teu7BCZTgDs");
        }
    }
