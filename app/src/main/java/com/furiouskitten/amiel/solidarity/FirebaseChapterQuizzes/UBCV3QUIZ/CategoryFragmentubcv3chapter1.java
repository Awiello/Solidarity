...
public class CategoryFragmentubcv3chapter1 extends Fragment {
    ...
    public static CategoryFragmentubcv3chapter1 newInstance(){
        CategoryFragmentubcv3chapter1 categoryFragment = new CategoryFragmentubcv3chapter1();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv3chapter1";
