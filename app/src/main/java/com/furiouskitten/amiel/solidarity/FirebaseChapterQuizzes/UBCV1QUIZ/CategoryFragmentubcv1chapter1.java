...
public class CategoryFragmentubcv1chapter1 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter1 newInstance(){
        CategoryFragmentubcv1chapter1 categoryFragment = new CategoryFragmentubcv1chapter1();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter1";
