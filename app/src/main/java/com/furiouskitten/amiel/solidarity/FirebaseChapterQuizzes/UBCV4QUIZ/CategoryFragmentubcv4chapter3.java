...
public class CategoryFragmentubcv4chapter3 extends Fragment {
    ...
    public static CategoryFragmentubcv4chapter3 newInstance(){
        CategoryFragmentubcv4chapter3 categoryFragment = new CategoryFragmentubcv4chapter3();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv4chapter3";
