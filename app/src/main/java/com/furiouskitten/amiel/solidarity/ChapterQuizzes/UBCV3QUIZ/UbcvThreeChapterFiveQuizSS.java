...
public class UbcvThreeChapterFiveQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvThreeChapterFiveQuizSS.this, UbcvThreeChapterFive.class));
                Animatoo.animateFade(UbcvThreeChapterFiveQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvThreeChapterFiveQuizSS.this, UbcvThreeChapterFiveQuiz.class);
