...
public class UbcvTwoChapterNineQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterNineQuizSS.this, UbcvTwoChapterNine.class));
                Animatoo.animateFade(UbcvTwoChapterNineQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterNineQuizSS.this, UbcvTwoChapterNineQuiz.class);
