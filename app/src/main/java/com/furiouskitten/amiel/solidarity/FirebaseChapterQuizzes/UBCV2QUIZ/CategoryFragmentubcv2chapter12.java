...
public class CategoryFragmentubcv2chapter12 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter12 newInstance(){
        CategoryFragmentubcv2chapter12 categoryFragment = new CategoryFragmentubcv2chapter12();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter12";
