...
public class CategoryFragmentubcv2chapter14 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter14 newInstance(){
        CategoryFragmentubcv2chapter14 categoryFragment = new CategoryFragmentubcv2chapter14();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter14";
