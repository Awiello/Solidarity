...
public class UbcvOne_PageOne extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pageContentTwo = "The Educational System was very much paralyzed due to lack of school buildings reduced to ashes, loss of equipment, facilities, and other school paraphernalia destroyed by the fire and the elements. \n \n in addition, there was a pressing demand for the resumption of classes disrupted by the war for a long time. It was the worst time for the Batangueños to begin a new life from the scratches but education must continue for the intellectual development of the youths of batangas.";
