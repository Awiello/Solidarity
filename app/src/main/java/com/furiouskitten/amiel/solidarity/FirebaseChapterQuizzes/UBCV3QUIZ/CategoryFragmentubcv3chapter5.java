...
public class CategoryFragmentubcv3chapter5 extends Fragment {
    ...
    public static CategoryFragmentubcv3chapter5 newInstance(){
        CategoryFragmentubcv3chapter5 categoryFragment = new CategoryFragmentubcv3chapter5();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv3chapter5";
