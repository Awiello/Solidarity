...
public class GodKnowsEverything extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_god_knows_everything);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), UbcvTwoChapterEleven.class);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("ugpYtX-h1jQ");
        }
    }
