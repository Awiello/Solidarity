...
public class BookDetailActivityThree extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_detail_three);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.book_detail_activity_three, menu);
        return true;
    }
    ...
    void iniViews() {
        ...
        chaptersButton = findViewById(R.id.chaptersButton);
        chaptersButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BookDetailActivityThree.this, UbcvThreeChaptersActivity.class));
                Animatoo.animateFade(BookDetailActivityThree.this);
            }
        });
