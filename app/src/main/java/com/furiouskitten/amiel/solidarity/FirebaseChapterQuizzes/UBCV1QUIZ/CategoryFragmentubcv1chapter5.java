...
public class CategoryFragmentubcv1chapter5 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter5 newInstance(){
        CategoryFragmentubcv1chapter5 categoryFragment = new CategoryFragmentubcv1chapter5();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter5";
