...
public class UbcvThreeChapterThreeQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvThreeChapterThreeQuizSS.this, UbcvThreeChapterThree.class));
                Animatoo.animateFade(UbcvThreeChapterThreeQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvThreeChapterThreeQuizSS.this, UbcvThreeChapterThreeQuiz.class);
