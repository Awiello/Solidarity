...
public class UbcvOneChapterNineQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterNineQuizSS.this, UbcvOneChapterNine.class));
                Animatoo.animateFade(UbcvOneChapterNineQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterNineQuizSS.this, UbcvOneChapterNineQuiz.class);
