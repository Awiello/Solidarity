...
public class UbcvOneChapterSevenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterSevenQuizSS.this, UbcvOneChapterSeven.class));
                Animatoo.animateFade(UbcvOneChapterSevenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterSevenQuizSS.this, UbcvOneChapterSevenQuiz.class);
