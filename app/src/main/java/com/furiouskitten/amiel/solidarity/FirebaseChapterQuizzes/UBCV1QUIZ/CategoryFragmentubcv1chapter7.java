...
public class CategoryFragmentubcv1chapter7 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter7 newInstance(){
        CategoryFragmentubcv1chapter7 categoryFragment = new CategoryFragmentubcv1chapter7();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter7";
