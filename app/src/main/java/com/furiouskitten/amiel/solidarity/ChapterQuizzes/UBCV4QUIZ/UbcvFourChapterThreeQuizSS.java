...
public class UbcvFourChapterThreeQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvFourChapterThreeQuizSS.this, UbcvFourChapterThree.class));
                Animatoo.animateFade(UbcvFourChapterThreeQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvFourChapterThreeQuizSS.this, UbcvFourChapterThreeQuiz.class);
