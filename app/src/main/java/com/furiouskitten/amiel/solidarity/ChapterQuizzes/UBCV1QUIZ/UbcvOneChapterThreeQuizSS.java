...
public class UbcvOneChapterThreeQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterThreeQuizSS.this, UbcvOneChapterThree.class));
                Animatoo.animateFade(UbcvOneChapterThreeQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterThreeQuizSS.this, UbcvOneChapterThreeQuiz.class);
