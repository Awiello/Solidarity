package com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV4QUIZ;
...
import com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV3QUIZ.UbcvThreeChapterFiveQuiz;
...
public class UbcvFourChapterOneQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvFourChapterOneQuizSS.this, UbcvFourChapterOne.class));
                Animatoo.animateFade(UbcvFourChapterOneQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvFourChapterOneQuizSS.this, UbcvFourChapterOneQuiz.class);
    ...
    private void buttonShow(){
        if(highscore != 0){
            textRecap.setVisibility(View.VISIBLE);
            textTitle.setVisibility(View.GONE);
            buttonStartQuiz.setVisibility(View.GONE);
            buttonStartQuizAgain.setVisibility(View.VISIBLE);
            buttonGoToChapters.setVisibility(View.GONE);
            buttonGoToChaptersTwo.setVisibility(View.VISIBLE);
