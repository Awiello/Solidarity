...
public class UbcvTwoChapterThirteenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterThirteenQuizSS.this, UbcvTwoChapterThirteen.class));
                Animatoo.animateFade(UbcvTwoChapterThirteenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterThirteenQuizSS.this, UbcvTwoChapterThirteenQuiz.class);
