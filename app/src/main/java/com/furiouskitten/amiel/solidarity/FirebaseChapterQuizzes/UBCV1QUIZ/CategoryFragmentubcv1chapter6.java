...
public class CategoryFragmentubcv1chapter6 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter6 newInstance(){
        CategoryFragmentubcv1chapter6 categoryFragment = new CategoryFragmentubcv1chapter6();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter6";
