...
public class UbcvTwoChapterElevenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterElevenQuizSS.this, UbcvTwoChapterEleven.class));
                Animatoo.animateFade(UbcvTwoChapterElevenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterElevenQuizSS.this, UbcvTwoChapterElevenQuiz.class);
