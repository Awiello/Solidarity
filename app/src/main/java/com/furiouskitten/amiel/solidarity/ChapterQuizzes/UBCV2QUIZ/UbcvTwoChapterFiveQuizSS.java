...
public class UbcvTwoChapterFiveQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterFiveQuizSS.this, UbcvTwoChapterFive.class));
                Animatoo.animateFade(UbcvTwoChapterFiveQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterFiveQuizSS.this, UbcvTwoChapterFiveQuiz.class);
