...
public class CategoryFragmentubcv1chapter9 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter9 newInstance(){
        CategoryFragmentubcv1chapter9 categoryFragment = new CategoryFragmentubcv1chapter9();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter9";
