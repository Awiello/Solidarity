package com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV1QUIZ;
...
import com.furiouskitten.amiel.solidarity.QuizComponents.StartingScreenActivityUbcvOneChapterOne;
import com.furiouskitten.amiel.solidarity.R;

import java.util.List;

public class UbcvOneChapterOneQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterOneQuizSS.this, UbcvOne_PageOne.class));
                Animatoo.animateFade(UbcvOneChapterOneQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        ...
        Intent intent = new Intent(UbcvOneChapterOneQuizSS.this, UbcvOneChapterOneQuiz.class);
