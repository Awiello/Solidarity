...
public class CategoryFragmentubcv2chapter9 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter9 newInstance(){
        CategoryFragmentubcv2chapter9 categoryFragment = new CategoryFragmentubcv2chapter9();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter9";
