...
public class CategoryFragmentubcv2chapter13 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter13 newInstance(){
        CategoryFragmentubcv2chapter13 categoryFragment = new CategoryFragmentubcv2chapter13();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter13";
