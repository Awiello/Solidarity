...
public class CategoryFragmentubcv4chapter2 extends Fragment {
    ...
    public static CategoryFragmentubcv4chapter2 newInstance(){
        CategoryFragmentubcv4chapter2 categoryFragment = new CategoryFragmentubcv4chapter2();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv4chapter2";
