...
public class UbcvTwoChapterTwelveQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterTwelveQuizSS.this, UbcvTwoChapterTwelve.class));
                Animatoo.animateFade(UbcvTwoChapterTwelveQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterTwelveQuizSS.this, UbcvTwoChapterTwelveQuiz.class);
