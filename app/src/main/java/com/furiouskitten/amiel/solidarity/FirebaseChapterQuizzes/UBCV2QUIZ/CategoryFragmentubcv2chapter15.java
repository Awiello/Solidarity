...
public class CategoryFragmentubcv2chapter15 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter15 newInstance(){
        CategoryFragmentubcv2chapter15 categoryFragment = new CategoryFragmentubcv2chapter15();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter15";
