...
public class FormsOfPrayer extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forms_of_prayer);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), UbcvTwoChapterFifteen.class);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("vyJlUOLb_ig");
        }
    }
