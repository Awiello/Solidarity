...
public class UbcvTwoChapterSevenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterSevenQuizSS.this, UbcvTwoChapterSeven.class));
                Animatoo.animateFade(UbcvTwoChapterSevenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterSevenQuizSS.this, UbcvTwoChapterSevenQuiz.class);
