...
public class UbcvThreeChapFour extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubcv_three_chap_four);
    ...
    public void transiBtn(View view){
        if(view == findViewById(R.id.nextPageButton)){
            startActivity(new Intent(this, UbcvTwoChapterOneQuizSS.class));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ubcv_three_chap_four, menu);
        return true;
    }
