...
public class BookDetailActivityFour extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_detail_four);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.book_detail_activity_four, menu);
        return true;
    }
    ...
    void iniViews() {
        ...
        chaptersButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(BookDetailActivityFour.this, UbcvFourChaptersActivity.class));
                Animatoo.animateFade(BookDetailActivityFour.this);
            }
        });
