...
public class UbcvTwoChapterThreeQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterThreeQuizSS.this, UbcvTwoChapterThreeQuiz.class));
                Animatoo.animateFade(UbcvTwoChapterThreeQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterThreeQuizSS.this, UbcvTwoChapterThreeQuiz.class);
