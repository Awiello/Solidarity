...
public class StartingScreenActivityUbcvOneChapterOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(StartingScreenActivityUbcvOneChapterOne.this, UbcvOneChaptersActivity.class));
                Animatoo.animateFade(StartingScreenActivityUbcvOneChapterOne.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        ...
        Intent intent = new Intent(StartingScreenActivityUbcvOneChapterOne.this, QuizActivityUbcvOneChapterOne.class);
