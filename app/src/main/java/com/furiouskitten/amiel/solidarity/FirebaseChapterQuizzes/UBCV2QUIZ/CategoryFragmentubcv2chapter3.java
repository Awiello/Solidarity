...
public class CategoryFragmentubcv2chapter3 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter3 newInstance(){
        CategoryFragmentubcv2chapter3 categoryFragment = new CategoryFragmentubcv2chapter3();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter3";
