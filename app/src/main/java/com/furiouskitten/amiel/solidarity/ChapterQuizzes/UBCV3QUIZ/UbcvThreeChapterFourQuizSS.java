...
public class UbcvThreeChapterFourQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvThreeChapterFourQuizSS.this, UbcvThreeChapterFour.class));
                Animatoo.animateFade(UbcvThreeChapterFourQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvThreeChapterFourQuizSS.this, UbcvThreeChapterFiveQuiz.class);
