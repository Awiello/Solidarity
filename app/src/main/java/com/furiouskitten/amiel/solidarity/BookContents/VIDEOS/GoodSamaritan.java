...
public class GoodSamaritan extends AppCompatActivity implements YouTubePlayer.OnInitializedListener, YouTubePlayer.PlayerStateChangeListener, YouTubePlayer.PlaybackEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_samaritan);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), UbcvFourChapterThree.class);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("53Pqw20xK10");
        }
    }
