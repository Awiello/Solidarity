...
public class UbcvOneChapterFourQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterFourQuizSS.this, UbcvOneChapterFour.class));
                Animatoo.animateFade(UbcvOneChapterFourQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterFourQuizSS.this, UbcvOneChapterFourQuiz.class);
