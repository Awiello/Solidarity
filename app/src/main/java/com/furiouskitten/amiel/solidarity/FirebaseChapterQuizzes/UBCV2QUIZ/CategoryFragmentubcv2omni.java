...
public class CategoryFragmentubcv2omni extends Fragment {
    ...
    public static CategoryFragmentubcv2omni newInstance(){
        CategoryFragmentubcv2omni categoryFragment = new CategoryFragmentubcv2omni();
