...
import com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV2QUIZ.UbcvTwoChapterEightQuiz;
import com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV2QUIZ.UbcvTwoChapterTwoQuiz;
...
public class UbcvThreeChapterTwoQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvThreeChapterTwoQuizSS.this, UbcvThreeChapterTwo.class));
                Animatoo.animateFade(UbcvThreeChapterTwoQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvThreeChapterTwoQuizSS.this, UbcvThreeChapterTwoQuiz.class);
