...
public class CategoryFragmentubcv2chapter5 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter5 newInstance(){
        CategoryFragmentubcv2chapter5 categoryFragment = new CategoryFragmentubcv2chapter5();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter5";
