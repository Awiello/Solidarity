...
public class CategoryFragmentubcv1chapter8 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter8 newInstance(){
        CategoryFragmentubcv1chapter8 categoryFragment = new CategoryFragmentubcv1chapter8();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter8";
