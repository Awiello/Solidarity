...
public class UbcvOneActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubcv_one);
        ...
        mUbcvOneModels.add(new UbcvOneChaptersModel(R.drawable.brochure, "Post-War Batangas: The Transition Year."));
        ...
        //run method firebase credentials
        updateNavHeader();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ubcv_one, menu);
        return true;
    }
    ...
    public void updateNavHeader(){
        ...
        TextView navUserMail = headerView.findViewById(R.id.bookMenuEmail);
        ImageView navUserPhoto = headerView.findViewById(R.id.bookMenuImageView);
