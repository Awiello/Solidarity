...
public class CategoryFragmentubcv2chapter10 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter10 newInstance(){
        CategoryFragmentubcv2chapter10 categoryFragment = new CategoryFragmentubcv2chapter10();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter10";
