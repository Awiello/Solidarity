...
public class CategoryFragmentubcv3chapter3 extends Fragment {
    ...
    public static CategoryFragmentubcv3chapter3 newInstance(){
        CategoryFragmentubcv3chapter3 categoryFragment = new CategoryFragmentubcv3chapter3();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv3chapter3";
