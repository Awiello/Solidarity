...
public class    UbcvOneChapterEightQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterEightQuizSS.this, UbcvOneChapterEight.class));
                Animatoo.animateFade(UbcvOneChapterEightQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterEightQuizSS.this, UbcvOneChapterEightQuiz.class);
