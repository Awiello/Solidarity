...
public class CategoryFragmentubcv3chapter4 extends Fragment {
    ...
    public static CategoryFragmentubcv3chapter4 newInstance(){
        CategoryFragmentubcv3chapter4 categoryFragment = new CategoryFragmentubcv3chapter4();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv3chapter4";
