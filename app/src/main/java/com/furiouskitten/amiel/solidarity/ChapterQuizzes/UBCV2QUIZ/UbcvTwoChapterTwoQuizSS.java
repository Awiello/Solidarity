package com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV2QUIZ;
...
import com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV1QUIZ.UbcvOneChapterEightQuiz;
...
public class UbcvTwoChapterTwoQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterTwoQuizSS.this, UbcvOneChapterTwo.class));
                Animatoo.animateFade(UbcvTwoChapterTwoQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterTwoQuizSS.this, UbcvTwoChapterTwoQuiz.class);
