...
public class CategoryFragmentubcv1chapter4 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter4 newInstance(){
        CategoryFragmentubcv1chapter4 categoryFragment = new CategoryFragmentubcv1chapter4();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter4";
