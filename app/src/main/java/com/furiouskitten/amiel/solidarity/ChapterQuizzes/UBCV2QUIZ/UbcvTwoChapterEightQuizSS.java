...
public class UbcvTwoChapterEightQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterEightQuizSS.this, UbcvTwoChapterEight.class));
                Animatoo.animateFade(UbcvTwoChapterEightQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterEightQuizSS.this, UbcvTwoChapterEightQuiz.class);
