...
public class CategoryFragmentubcv2chapter2 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter2 newInstance(){
        CategoryFragmentubcv2chapter2 categoryFragment = new CategoryFragmentubcv2chapter2();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter2";
