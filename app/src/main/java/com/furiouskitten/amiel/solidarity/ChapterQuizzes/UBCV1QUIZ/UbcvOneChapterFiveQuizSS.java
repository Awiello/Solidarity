...
public class UbcvOneChapterFiveQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterFiveQuizSS.this, UbcvOneChapterFive.class));
                Animatoo.animateFade(UbcvOneChapterFiveQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterFiveQuizSS.this, UbcvOneChapterFiveQuiz.class);
