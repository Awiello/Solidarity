...
public class CategoryFragmentubcv1chapter3 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter3 newInstance(){
        CategoryFragmentubcv1chapter3 categoryFragment = new CategoryFragmentubcv1chapter3();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter3";
