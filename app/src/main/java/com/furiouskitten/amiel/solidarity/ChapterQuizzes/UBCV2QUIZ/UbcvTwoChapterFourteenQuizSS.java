...
public class UbcvTwoChapterFourteenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterFourteenQuizSS.this, UbcvTwoChapterFourteen.class));
                Animatoo.animateFade(UbcvTwoChapterFourteenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterFourteenQuizSS.this, UbcvTwoChapterFourteenQuiz.class);
