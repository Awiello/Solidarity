...
public class CategoryFragmentubcv1chapter2 extends Fragment {
    ...
    public static CategoryFragmentubcv1chapter2 newInstance(){
        CategoryFragmentubcv1chapter2 categoryFragment = new CategoryFragmentubcv1chapter2();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv1chapter2";
