...
public class UbcvTwoChapterOneQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterOneQuizSS.this, UbcvTwoChapterOne.class));
                Animatoo.animateFade(UbcvTwoChapterOneQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterOneQuizSS.this, UbcvTwoChapterOneQuiz.class);
