...
import com.furiouskitten.amiel.solidarity.BookContents.VIDEOS.GodKnowsEverything;
import com.furiouskitten.amiel.solidarity.ChapterQuizzes.UBCV2QUIZ.UbcvTwoChapterElevenQuizSS;
...
import com.furiouskitten.amiel.solidarity.FirebaseChapterQuizzes.UBCV2QUIZ.Homeubcv2chapter11;
...
public class UbcvTwoChapterEleven extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubcv_two_chapter_eleven);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Chapter 2.10: God is Spirit");
        ...
        String pageContent =
"Objectives: At the end of this lesson, the students should be able to:\n\n 1. Discover that God alone knows everything.\n\n2. Show some scriptural support for this characteristic of God.\n\n3. Share some experiences or event in their life where they have experience God's leading and guidance.\n\n4. Decide to live a life fully consecrated to God and in His service. Definition: God is a non-material personal being, self-conscious and self-de-termining.\n\nMeaning: God is someone we can get to know. He, unlike ourselves, doesn't need to be told what to do. On the other hand He tells us what to do and how to live in a manlier pleasing to Him. Just because He can't be seen by the human eye doesn't mean.\n\n He is not there and therefore should be ignored. Quite the opposite is true, His creation demonstrates His existence. Also. since he cannot be seen, we need to devote ourselves to study everything that has been written about Him so that we can get to know Him like He wants us to and begin to live our lives in a way that pleases Him.";
        String pageContentTwo = "Scripture Support: \n\n  John 4:24 God is a Spirit: and they that worship him must worship him in spirit and in truth. John 1:18 No man hath seen God at any time; the only begotten Son, which is in the bosom of the Father, he hath declared him.\n\n I Timothy 6:16 Who only hath immortality, dwelling in the light which no may can approach unto; whom no man hath seen, nor can see: to whom be honour and power everlasting. Amen.\n\nLuke 24:39 Behold my hands and my feet, that it is I myself: handle Me' and see; for a spirit hath not flesh and bones, as ye see me have.Romans 1:20 For the invisible things of him from the creation of the world are clearly seen, being understood by the things that are made, even his eternal power and Godhead; so that they are without excuse.\n\n I Timothy 1:17  Now unto the King eternal, immortal, invisible, the only wise God. be honour and glory forever and ever. Amen. Conclusion: God has no image. He cannot be seen by the human eye, but creation points to His existence. His Son, Jesus testified to His exist-ence and desire to be sought by His creatures. He also provided us with an example of how to live our lives seeking and serving God.";

        mChapterText.setText("Lesson 2.10");
        mTitleText.setText("God is Spirit");

        SpannableString spannableOne = new SpannableString(pageContent);
        ClickableSpan clickableSpanOne = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View widget) {
                Intent intent = new Intent(getApplicationContext(), GodKnowsEverything.class);
        ...
        spannableOne.setSpan(clickableSpanOne, 89,115, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void transiBtn(View view){
        if(view == findViewById(R.id.nextPageButton)){
            startActivity(new Intent(this, Homeubcv2chapter11.class));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.ubcv_two_chapter_eleven, menu);
        return true;
    }
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cueVideo("oNNZO9i1Gjc");
        }
    }
