...
public class UbcvTwoChapterTenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterTenQuizSS.this, UbcvTwoChapterTen.class));
                Animatoo.animateFade(UbcvTwoChapterTenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterTenQuizSS.this, UbcvTwoChapterTenQuiz.class);
