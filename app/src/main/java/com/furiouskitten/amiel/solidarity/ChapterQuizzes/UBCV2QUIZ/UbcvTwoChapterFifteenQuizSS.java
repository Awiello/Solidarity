...
public class UbcvTwoChapterFifteenQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterFifteenQuizSS.this, UbcvTwoChapterFifteen.class));
                Animatoo.animateFade(UbcvTwoChapterFifteenQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterFifteenQuizSS.this, UbcvTwoChapterFifteenQuiz.class);
