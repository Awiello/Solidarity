...
public class UbcvFourChapterTwoQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvFourChapterTwoQuizSS.this, UbcvFourChapterTwo.class));
                Animatoo.animateFade(UbcvFourChapterTwoQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvFourChapterTwoQuizSS.this, UbcvFourChapterTwoQuiz.class);
