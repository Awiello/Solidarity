...
public class CategoryFragmentubcv2chapter7 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter7 newInstance(){
        CategoryFragmentubcv2chapter7 categoryFragment = new CategoryFragmentubcv2chapter7();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter7";
