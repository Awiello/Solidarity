...
public class CategoryFragmentubcv4chapter1 extends Fragment {
    ...
    public static CategoryFragmentubcv4chapter1 newInstance(){
        CategoryFragmentubcv4chapter1 categoryFragment = new CategoryFragmentubcv4chapter1();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv4chapter1";
