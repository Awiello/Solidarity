...
import com.furiouskitten.amiel.solidarity.BookContents.UBCV3.UbcvThreeChapFour;
...
public class UbcvThreeAdapters extends RecyclerView.Adapter<UbcvThreeAdapters.myUbcvAdapterViewHolder> {
    ...
    public UbcvThreeAdapters(Context context, List<UbcvOneChaptersModel> models) {
        ...
        myUbcvAdapterViewHolder.mChaptersCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(position == 0){
                    ...
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterOne.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                } else if(position == 1){
                    pleaseWaitDialog.dismiss();
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterTwo.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                } else if(position == 2){
                    pleaseWaitDialog.dismiss();
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterThree.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                }else if(position == 3){
                    pleaseWaitDialog.dismiss();
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterFour.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                }else if(position == 4){
                    pleaseWaitDialog.dismiss();
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterFive.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                }else if(position == 5){
                    pleaseWaitDialog.dismiss();
                    Intent chapterContentIntent = new Intent (mContext, UbcvThreeChapterSix.class);
                    mContext.startActivity(chapterContentIntent);
                    ((Activity)mContext).finish();
                }
            }
