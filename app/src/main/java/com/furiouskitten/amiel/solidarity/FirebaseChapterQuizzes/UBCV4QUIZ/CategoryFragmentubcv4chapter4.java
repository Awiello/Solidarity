...
public class CategoryFragmentubcv4chapter4 extends Fragment {
    ...
    public static CategoryFragmentubcv4chapter4 newInstance(){
        CategoryFragmentubcv4chapter4 categoryFragment = new CategoryFragmentubcv4chapter4();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv4chapter4";
