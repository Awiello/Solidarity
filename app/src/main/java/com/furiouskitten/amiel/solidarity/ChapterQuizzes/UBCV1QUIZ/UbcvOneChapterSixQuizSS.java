...
public class UbcvOneChapterSixQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvOneChapterSixQuizSS.this, UbcvOneChapterSix.class));
                Animatoo.animateFade(UbcvOneChapterSixQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvOneChapterSixQuizSS.this, UbcvOneChapterSixQuiz.class);
