...
public class UbcvTwoChapterSixQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterSixQuizSS.this, UbcvTwoChapterSix.class));
                Animatoo.animateFade(UbcvTwoChapterSixQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterSixQuizSS.this, UbcvTwoChapterSixQuiz.class);
