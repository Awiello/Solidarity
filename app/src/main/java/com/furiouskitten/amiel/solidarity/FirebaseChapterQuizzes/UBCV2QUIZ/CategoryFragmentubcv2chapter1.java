...
public class CategoryFragmentubcv2chapter1 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter1 newInstance(){
        CategoryFragmentubcv2chapter1 categoryFragment = new CategoryFragmentubcv2chapter1();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter1";
