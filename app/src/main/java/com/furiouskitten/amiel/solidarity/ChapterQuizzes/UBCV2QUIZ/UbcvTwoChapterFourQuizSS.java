...
public class UbcvTwoChapterFourQuizSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGoToChapters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UbcvTwoChapterFourQuizSS.this, UbcvTwoChapterFour.class));
                Animatoo.animateFade(UbcvTwoChapterFourQuizSS.this);
                finish();
            }
        });
    ...
    private void startQuiz() {
        //baguhin sa naaayon
        Intent intent = new Intent(UbcvTwoChapterFourQuizSS.this, UbcvTwoChapterFour.class);
