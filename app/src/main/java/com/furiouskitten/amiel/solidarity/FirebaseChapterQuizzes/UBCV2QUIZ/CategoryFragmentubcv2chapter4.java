...
public class CategoryFragmentubcv2chapter4 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter4 newInstance(){
        CategoryFragmentubcv2chapter4 categoryFragment = new CategoryFragmentubcv2chapter4();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter4";
