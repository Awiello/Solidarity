...
public class CategoryFragmentubcv2chapter11 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter11 newInstance(){
        CategoryFragmentubcv2chapter11 categoryFragment = new CategoryFragmentubcv2chapter11();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter11";
