...
public class CategoryFragmentubcv2chapter6 extends Fragment {
    ...
    public static CategoryFragmentubcv2chapter6 newInstance(){
        CategoryFragmentubcv2chapter6 categoryFragment = new CategoryFragmentubcv2chapter6();
    ...
    private void loadCategory(){
        testBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common.categoryId = "ubcv2chapter6";
